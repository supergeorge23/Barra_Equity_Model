...
def factor_analysis_main():
    ...
    def calculate_factors_for_stock(stock_code, target_date_rank):
        ...
        factor_functions = [calculate_single_NLSIZE, calculate_single_beta, calculate_single_RSTR,
                            ...
                            calculate_single_EGRO, calculate_single_SGRO, calculate_single_BTOP,
                            calculate_single_MLEV, calculate_single_DTOA, calculate_single_BLEV,
                            calculate_single_STOM, calculate_single_STOQ, calculate_single_STOA]
    ...
    if __name__ == "__main__":
        ...
        all_stock_data_np_20230512 = all_stock_data_np[all_stock_data_np[:, 2] == '20230310']
        ...
        results_array = calculate_factors_for_stock_vectorized(unique_stock_codes_20230512, target_date_rank=1165)
        ...
        np.save('20230310_results_array.npy', results_array)
        ...
        np.save('20230310_normalized_results_array.npy', normalized_results_df)
